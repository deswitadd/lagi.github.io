...
<html lang="en">
  ...
  <body>
    <audio
      autoplay="true"
      loop
      src="https://res.cloudinary.com/dlr8gie0d/video/upload/v1617498637/hbd_lrzzzr.mp3"
    ></audio>
    <div class="container">
      <div class="one">
        <h1 class="one">
          Hey
          <span id="name"></span> AGUNG
        </h1>
        <p class="two" id="greetingText">I HOPE YOU FINE TODAY!</p>
      </div>
      <div class="three">
 ...
 .  
      ...
      <div class="six">
<img src="rsz_1agung.jpg" alt="" class="rsz_1agung"  /> 
 
     <div class="rsz_1agung" >
<img src="rsz_1agung.jpg" alt="" class="rsz_1agung" id="imagePath" />
	 ...
	 <span id="name"></span>
        ...
        <div class="wish">
          ...
          <h5 id="wishText"> SEMOGA JADI PRIBADI YANG LEBIH BAIK ;)</h5>
        </div>
      </div>
      <div class="seven">
        <div class="baloons">
